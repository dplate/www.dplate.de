...
import styles from './PageAncient.module.css';
    ...
    <>
      <div>
        <div className={cardStyle}>
          <h1>Labyland</h1>
          <img className={`${pictureStyle} ${styles.picture}`} src="/screenshots/labyland.jpg" />
          <p>
        ...
        <div className={cardStyle}>
          <h1>Cups</h1>
          <img className={`${pictureStyle} ${styles.picture}`} src="/screenshots/cups.jpg" />
          <p>
        ...
        <div className={cardStyle}>
          ...
          <img className={`${pictureStyle} ${styles.picture}`} src="/screenshots/vulkan.jpg" />
          <p>
        ...
        <div className={cardStyle}>
          ...
          <img className={`${pictureStyle} ${styles.picture}`} src="/screenshots/katapult.jpg" />
          <p>
        ...
        <div className={cardStyle}>
          <h1>Zahlorie</h1>
          <img className={`${pictureStyle} ${styles.picture}`} src="/screenshots/zahlorie.jpg" />
          <p>
