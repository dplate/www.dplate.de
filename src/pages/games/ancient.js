      ...
      <div>
        ...
        <Card>
          ...
          <p>
            ...
            <a href={__PATH_PREFIX__ + '/zips/labyland.zip'}>labyland.zip: 181 KByte</a>
          </p>
          <p>
            Sourcecode für Pascal:<br />
            <a href={__PATH_PREFIX__ + '/zips/labylandsdk.zip'}>labylandsdk.zip: 48 KByte</a>
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            Download (Windows 3.1 oder Windows XP notwendig):<br />
            <a href={__PATH_PREFIX__ + '/zips/cups.zip'}>cups.zip: 211 KByte</a>
          </p>
          <p>
            Sourcecode für Pascal:<br />
            <a href={__PATH_PREFIX__ + '/zips/labylandsdk.zip'}>cupssdk.zip: 28 KByte</a>
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            ...
            <a href={__PATH_PREFIX__ + '/zips/vulkan.zip'}>vulkan.zip: 2,1 MByte</a>
          </p>
          <p>
            Sourcecode für Pascal:<br />
            <a href={__PATH_PREFIX__ + '/zips/vulkansource.zip'}>vulkansource.zip: 11 KByte</a>
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            Download (Dosbox für Windows enthalten):<br />
            <a href={__PATH_PREFIX__ + '/zips/katapult.zip'}>katapult.zip: 1,7 MByte</a>
          </p>
          <p>
            Sourcecode für Pascal:<br />
            <a href={__PATH_PREFIX__ + '/zips/katapultsource.zip'}>katapultsource.zip: 5 KByte</a>
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            Download (Dosbox für Windows enthalten):<br />
            <a href={__PATH_PREFIX__ + '/zips/zahlorie.zip'}>zahlorie.zip: 1,7 MByte</a>
          </p>
          <p>
            Sourcecode für Pascal:<br />
            <a href={__PATH_PREFIX__ + '/zips/zahloriesource.zip'}>zahloriesource.zip: 9 KByte</a>
          </p>
        </Card>
      </div>
    </Layout>
