    ...
    <Layout location={props.location}>
      <div>
        ...
        <Card>
          ...
          <p><a href={__PATH_PREFIX__ + '/zips/ScapeMakerSetup_1_3.exe'}>ScapeMakerSetup_1_3.exe: 4,4 MByte</a></p>
          <h2>Original Sourcecode für C++ mit DirectxSDK</h2>
          <p><a href={__PATH_PREFIX__ + '/zips/scapemakersdk.zip'}>scapemakersdk.zip: 17 MByte</a></p>
        </Card>
     </div>
    </Layout>
  );
